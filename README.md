...
- Players are **auto-rotated** across tables each round to minimise repeat opponents, with **Move players** (tap to swap two players, move into an empty seat, add a seat to a table — e.g. grow a 3-player table to 4 for a late arrival — or bench someone) and **re-pair** to reshuffle.
...
- When the champion is crowned, **Save &amp; finish** archives the night to a **Past champions** history on the start screen — every saved night's bracket and standings stay viewable.
